                ...
                <article className="grid grid-cols-5 gap-8 border-dashed border border-black">
                    ...
                    <div className="flex flex-col items-center">
                        <Image
                            ...
                            //   className="rounded-md right-10 absolute top-0 -z-100"
                        />
                        <span className="font-bold text-2xl">MongoDB</span>
                    </div>
                    <div className="flex flex-col items-center">
                        <Image
                            ...
                            //   className="rounded-md right-10 absolute top-0 -z-100"
                        />
                        <span className="font-bold text-2xl">NodeJS</span>
                    </div>
                    <div className="flex flex-col items-center">
                        <Image
                            ...
                            //   className="rounded-md right-10 absolute top-0 -z-100"
                        />
                        <span className="font-bold text-2xl">Express</span>
                    </div>
                    <div className="flex flex-col items-center">
                        <Image
            ...
            <article className="grid grid-cols-3 gap-8 px-32">
                <div className="bg-brand-400 flex flex-col ">
                    ...
                    <p className="text-xl px-8 pb-16 font-light tracking-tighter">
                        I designed Shelfie web application for book lovers to
                        share and discover book reviews.
                        <span className="font-bold">
                            {" "}
                            With 19+ real-world users
                        </span>
                        , the platform fosters an engaging environment where
                        users can create accounts, leave reviews, and interact
                        with others&apos; reviews. By implementing robust user{" "}
                        <span className="font-bold">
                            authentication using Firebase
                        </span>
                        , I ensured secure and seamless sign-ups via email,
                        password, or Google accounts. The integration of the{" "}
                        <span className="font-bold">
                            Google Books API with JavaScript&apos;s async/await
                        </span>
                        functionality guarantees users access to a vast library
                        of books, making discovery easy and enjoyable. Hosted on
                        Firebase, Shelfie benefits from scalable and reliable
                        deployment. This project highlights my{" "}
                        <span className="font-bold">
                            full-stack development skills
                        </span>
                        , from real-time data handling and{" "}
                        <span className="font-bold">API integration</span>
                        to creating a clean and accessible UI, all while
                        fostering a passionate community of readers.
                    </p>
                ...
                <div className="bg-brand-400 flex flex-col ">
                    ...
                    <span className="px-8 font-light text-xl pb-8 inline-block">
                        Stack: Node | Express | MongoDB | React | JavaScript |
                        CSS
                    </span>
                    <p className="text-xl px-8 pb-16 font-light tracking-tighter">
                        CoderComedy is an interactive web platform that
                        generates and displays jokes specifically for developers
                        and programmers. This project was a fun way to explore
                        <span className="font-bold">
                            APIs and DOM manipulation
                        </span>
                        , while also honing my skills in{" "}
                        <span className="font-bold">user interaction</span> and
                        interface design. Built with{" "}
                        <span className="font-bold">React</span>, the website
                        offers an intuitive layout, making it easy for users to
                        generate and enjoy tech-specific humor. By integrating
                        the{" "}
                        <span className="font-bold">
                            Joke API using JavaScript&apos;s async/await
                        </span>
                        , I enabled seamless asynchronous joke fetching and
                        display. The platform features a{" "}
                        <span className="font-bold">
                            fully responsive design
                        </span>
                        , with carefully applied{" "}
                        <span className="font-bold">CSS styling</span> to ensure
                        a visually appealing and user-friendly experience on all
                        devices. This project highlights my ability to build
                        engaging web applications that prioritize both
                ...
                <div className="bg-brand-400 flex flex-col ">
                    ...
                    <p className="text-xl px-8 pb-16 font-light tracking-tighter">
                        Omnifood is a landing page designed to help users
                        explore and choose healthy meal plans with ease. It
                        emphasizes a{" "}
                        ...
                        . The design is{" "}
                        <span className="font-bold">fully responsive</span>,
                        built with{" "}
                        <span className="font-bold">CSS Grid, Flexbox,</span>{" "}
                        and
                        <span className="font-bold"> media queries</span> to
                        ensure smooth functionality across all devices. The
                        project also prioritizes{" "}
                        <span className="font-bold">high performance</span>,
                        achieving over 90% scores in performance and
                        accessibility, ensuring fast load times and an{" "}
                        <span className="font-bold">
                            inclusive user experience
                        </span>
                        . With a perfect{" "}
                        <span className="font-bold">
                            100% in SEO and best practices
                        </span>
                        , the site enhances visibility and searchability.
                        Finally, it is seamlessly deployed on{" "}
                        <span className="font-bold">Netlify</span>, providing a
